...
public class AddPatient extends AddingPage {
    ...
    public AddPatient(DBConnection connection) {
        ...
        numOfDaysToStay = createTextField(numOfDaysToStay, 590, 230);


        pageJob = createButton(pageJob, 500, "Add");
    ...
    protected JComboBox<String> placeBox(int x_axis, int y_axis) {
        ...
        placeData = createCompoBox(placeData, x_axis, y_axis, rooms);
    ...
    protected int extractRoomID() {
        int room_ID;
        try {
            room_ID = Integer.parseInt((String) placeData.getSelectedItem());
            return room_ID;
        } catch (Exception e) {
            return -1;
        }
